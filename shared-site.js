(function() {
  ...
  var navHTML = ''
    + '<div class="nav-inner">'
    + '<a href="index.html" class="nav-brand">The I Love Method™</a>'
    + '<div class="nav-links">'
    ...
    + '<a href="30-day-journey.html" class="' + (page==='journey'?'active':'') + '">30-Day Journey</a>'
    + '<a href="about.html" class="' + (page==='about'?'active':'') + '">About</a>'
    + '<a href="insights.html" class="' + (page==='insights'?'active':'') + '">Insights</a>'
    + '</div>'
    + '<a href="30-day-journey.html" class="nav-cta">Start Your Journey</a>'
    ...
    + '<a href="30-day-journey.html">30-Day Journey</a>'
    + '<a href="about.html">About</a>'
    + '<a href="insights.html">Insights</a>'
    + '<a href="30-day-journey.html" class="nav-cta" style="text-align:center;margin-top:8px;">Start Your Journey</a>'
    + '</div>';
  ...
  var footerHTML = ''
    ...
    + '</div>'
    + '</div>'
    + '<div class="footer-bottom">© 2025 The I Love Method™ &nbsp;·&nbsp; All rights reserved<br>'
    + 'This course is for personal development and educational purposes only. It is not a substitute for professional medical, psychological, or mental health treatment.</div>';
